/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7605b4aada2c3d2600cd7f986baa91bf)
// Runtime types generated with workerd@1.20250604.0 2025-06-09 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    RUNTIME: 'workerd';
    WORKER_SELF_REFERENCE: Fetcher /* umami */;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'RUNTIME'>> {}
}
