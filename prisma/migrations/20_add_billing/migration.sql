...
-- CreateIndex
CREATE INDEX "billing_invoice_billing_id_idx" ON "billing_invoice"("billing_id");
...
-- CreateIndex
CREATE INDEX "billing_user_id_idx" ON "billing"("user_id");

-- CreateIndex
CREATE INDEX "billing_team_id_idx" ON "billing"("team_id");

-- CreateIndex
CREATE UNIQUE INDEX "billing_name_user_id_key" ON "billing"("name", "user_id");
