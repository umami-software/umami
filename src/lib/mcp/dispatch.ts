...
export const MCP_DISPATCH_ROUTES: readonly DispatchRoute[] = [
  ...
  },
  {
    ...
    load: () => import('@/app/api/websites/[websiteId]/attribution/route'),
  },
  {
    method: 'GET',
    path: '/api/websites/{websiteId}/breakdown',
    load: () => import('@/app/api/websites/[websiteId]/breakdown/route'),
  },
  {
    method: 'GET',
    path: '/api/websites/{websiteId}/funnels/stats',
    load: () => import('@/app/api/websites/[websiteId]/funnels/stats/route'),
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    load: () => import('@/app/api/websites/[websiteId]/retention/route'),
  },
  {
    method: 'GET',
    path: '/api/websites/{websiteId}/utm/metrics',
    load: () => import('@/app/api/websites/[websiteId]/utm/metrics/route'),
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    load: () => import('@/app/api/websites/[websiteId]/revenue/chart/route'),
  },
  {
    method: 'GET',
    path: '/api/websites/{websiteId}/revenue/metrics',
    load: () => import('@/app/api/websites/[websiteId]/revenue/metrics/route'),
  },
];
