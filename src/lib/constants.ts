...
// Maps ISO 3166-1 alpha-2 country codes (as stored in Umami) to alpha-3 codes (required by the GSC API)
export const COUNTRY_ALPHA2_TO_ALPHA3: Record<CountryCode, string> = {
  AD: 'and',
  AE: 'are',
  AF: 'afg',
  AG: 'atg',
