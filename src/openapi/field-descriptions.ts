...
const fieldDescriptions: Record<string, string> = {
  ...
  client_uri: 'URL of the OAuth client homepage.',
  logo_uri: 'URL of the OAuth client logo.',
  redirect_uri: 'Registered redirect URI to receive the authorization response.',
  redirect_uris: 'Redirect URIs registered for the OAuth client.',
  response_type: 'OAuth authorization response type; use code.',
  response_types: 'Authorization response types supported by the client.',
  code_challenge: 'PKCE challenge derived from the code verifier.',
  code_challenge_method: 'Method used to derive the PKCE challenge; use S256.',
  code_verifier: 'Original PKCE verifier used to obtain the authorization code.',
  scope: 'Space-separated OAuth permissions.',
  resource: 'Resource URI identifying the API targeted by the OAuth request.',
  state: 'Client-provided value returned unchanged to correlate the authorization response.',
  access_token: 'OAuth access token used to authorize API requests.',
  refresh_token: 'OAuth refresh token used to obtain a new access token.',
  token_type: 'Authorization scheme for the access token.',
  expires_in: 'Access token lifetime in seconds.',
  grant_type: 'OAuth grant used to obtain or refresh an access token.',
  grant_types: 'OAuth grant types supported by the client.',
  token_endpoint_auth_method: 'Client authentication method used at the token endpoint.',
  token_type_hint: 'Hint indicating whether the revoked token is an access or refresh token.',
  error_description: 'Human-readable explanation of the OAuth error.',
