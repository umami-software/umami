export const labels: Record<string, string> = {
  ...
  term: 'label.term',
  utmGeneratedUrl: 'label.utm-generated-url',
  ...
  utmGenerator: 'label.utm-generator',
  utmUrlPath: 'label.utm-url-path',
...
export const messages: Record<string, string> = {
  ...
  oauthLoginPrompt: 'message.oauth-login-prompt',
  oauthConsent: 'message.oauth-consent',
  oauthPermissions: 'message.oauth-permissions',
  oauthScopeWebsitesRead: 'message.oauth-scope-websites-read',
  oauthScopeAnalyticsRead: 'message.oauth-scope-analytics-read',
  oauthRedirectNotice: 'message.oauth-redirect-notice',
  oauthSignedInAs: 'message.oauth-signed-in-as',
  oauthInvalidRequest: 'message.oauth-invalid-request',
  oauthRedirecting: 'message.oauth-redirecting',
