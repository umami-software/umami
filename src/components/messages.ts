export const labels: Record<string, string> = {
  ...
  active: 'label.active',
  copyInvitationLink: 'label.copy-invitation-link',
  createAccount: 'label.create-account',
  createAccountAndJoinTeam: 'label.create-account-and-join-team',
  createInvitation: 'label.create-invitation',
  done: 'label.done',
  expired: 'label.expired',
  expires: 'label.expires',
  expiresIn: 'label.expires-in',
  invitationLink: 'label.invitation-link',
  invitations: 'label.invitations',
  invitationUnavailable: 'label.invitation-unavailable',
  oneDay: 'label.one-day',
  revoke: 'label.revoke',
  revoked: 'label.revoked',
  revokeInvitation: 'label.revoke-invitation',
  sevenDays: 'label.seven-days',
  signIn: 'label.sign-in',
  signInAndJoinTeam: 'label.sign-in-and-join-team',
  status: 'label.status',
  thirtyDays: 'label.thirty-days',
  used: 'label.used',
};
...
export const messages: Record<string, string> = {
  ...
  invalidTeamInvite: 'message.INVALID_TEAM_INVITE',
  usernameUnavailable: 'message.USERNAME_UNAVAILABLE',
};
