export const labels: Record<string, string> = {
  ...
  errorsOnly: 'label.errors-only',
  warningsAndErrors: 'label.warnings-and-errors',
  infoWarningsAndErrors: 'label.info-warnings-and-errors',
  debugAndAbove: 'label.debug-and-above',
  maxDuration: 'label.max-duration',
  blockSelector: 'label.block-selector',
  recordCanvas: 'label.record-canvas',
  canvasFps: 'label.canvas-fps',
  canvasQuality: 'label.canvas-quality',
...
export const messages: Record<string, string> = {
  ...
  consoleLogsWarning: 'message.console-logs-warning',
