export const labels: Record<string, string> = {
  ...
  customizePreview: 'label.customize-preview',
  customizePreviewDescription: 'label.customize-preview-description',
  imageUrl: 'label.image-url',
  autoDetectedFromDestination: 'label.auto-detected-from-destination',
